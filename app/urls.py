...
from .views import index,detail,create_product,delete_product,update_product,create_order,create_comment,contact_view,CommentCreateView
...
urlpatterns = [
    ...
    path('contact/',CommentCreateView.as_view(),name='contact_view'),
]
